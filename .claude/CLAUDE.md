...
> **Note:** When a global install exists at `~/.claude/`, the installer skips copying agents, skills, and shared protocols to projects. Use `--standalone` to override this behavior.
