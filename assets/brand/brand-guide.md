...
19 agents. 16 skills. One command to run the whole thing.
...
```
AI-powered dev team for Claude Code. 19 agents, 16 skills, project-local memory. miniature-guacamole.
```
(101 chars)

**Twitter/X bio (160 chars max):**
```
AI dev team for Claude Code. 19 agents, 16 skills. Deadpan. NDA-safe. Open source.
```
(83 chars)
