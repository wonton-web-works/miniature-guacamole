...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Turn Claude Code into a 19-agent product development team with specialized roles, collaborative skills, and TDD workflows.' }],
    ...
    ['meta', { name: 'twitter:description', content: 'Turn Claude Code into a 19-agent product development team with specialized roles, collaborative skills, and TDD workflows.' }],
