# Enterprise Page Visual Spec — PrivateEnterprise / The Sage
...
This spec covers six visual sections for the PrivateEnterprise enterprise marketing page. The page tells a single through-line story: the Sage (meditating capybara in green robes) guides the little bird (the client) through the complexity of a real software org. Every section continues that narrative.
...
- ARIA label on the section: `aria-label="PrivateEnterprise team hierarchy — 24 agents across 4 tiers, led by The Sage"`
