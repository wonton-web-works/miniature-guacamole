...
features:
  ...
  - icon: 🔄
    ...
    details: Disciplined test-driven development cycle with QA writing tests before dev implements. 99% code coverage enforced.
  - icon: 🧠
    title: Shared Memory System
    details: TypeScript-powered state management layer with atomic writes, file locking, and 99% test coverage. Query by agent, workstream, or time.
  - icon: 📋
...
- Engineers who want disciplined TDD/BDD workflows
