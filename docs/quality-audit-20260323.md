...
|------|-------|--------|------|
| index.astro | "PrivateEnterprise Enterprise — Your AI Engineering Org" | 48 chars | Pass |
| Base.astro default | "PrivateEnterprise — AI-powered dev team for Claude Code" | 49 chars | Pass |
...
| Deploy PrivateEnterprise | success | push to main |
| CI | **FAILURE** | push to main |
| CI | **FAILURE** | PR: fix/mobile-responsive-v2 |
| Deploy PrivateEnterprise | success | previous push |
...
- The **Deploy PrivateEnterprise** workflow succeeds, so the site is deploying correctly
