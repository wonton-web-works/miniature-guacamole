...
**Date:** 2026-03-22
**Applies to:** miniature-guacamole / TheEngOrg Enterprise Edition

---

## Overview

This document specifies the enterprise licensing system for TheEngOrg. The system protects the Sage agent and associated enterprise features from unauthorized redistribution. It operates in three layers:
...
- Lives in Wonton Web Works 1Password under `theengorg/license-signing-key`
...
[MG] Continuing in Community Mode. Contact support@theengorg.com to renew.
```
...
[MG] Continuing in Community Mode. If you believe this is an error, contact support@theengorg.com.
```
...
[MG] Contact support@theengorg.com to upgrade.
```

**Fingerprint mismatch:**
```
[MG] License is not valid on this machine.
[MG] Contact support@theengorg.com to transfer your license.
```
...
listed in LICENSE.enterprise, which are governed by the TheEngOrg
Enterprise License Agreement.
```

**`LICENSE.enterprise` (proprietary — applies to enterprise files):**
```
TheEngOrg Enterprise License Agreement
...
a valid TheEngOrg Enterprise License Agreement.
...
For licensing: enterprise@theengorg.com
Full agreement: [URL to agreement on theengorg.wontonwebworks.com]
```
...
src/framework/agents/
  sage/                    <- ENTERPRISE (proprietary)
    AGENT.md
    LICENSE                <- "See ../../LICENSE.enterprise"
  cmo/
...
For the public GitHub repo: the `sage/` directory is either absent entirely (best for Layer 3) or present with a placeholder `AGENT.md` that says "Enterprise feature. See theengorg.wontonwebworks.com for licensing."
...
See LICENSE.enterprise for terms or visit theengorg.wontonwebworks.com/enterprise
-->
```
...
```
GET https://registry.theengorg.wontonwebworks.com/enterprise/download
...
- If revoked: return 403 with message "License revoked. Contact support@theengorg.com."
...
2. **Legal deterrence:** The license agreement and LICENSE.enterprise file make redistribution a clear legal violation.
...
- [ ] Private key documented in 1Password under `theengorg/license-signing-key`
...
**Acceptance criteria:**
- [ ] Root `LICENSE` updated to clarify MIT scope and reference `LICENSE.enterprise`
- [ ] `LICENSE.enterprise` created with complete file list
- [ ] All enterprise files have correct license headers (Section 2.3)
- [ ] Sage directory has its own `LICENSE` file referencing `LICENSE.enterprise`
- [ ] `README.md` updated with a short "Licensing" section: MIT for community, enterprise agreement for enterprise features, link to theengorg.wontonwebworks.com/enterprise
