...
read:
  ...
  - .claude/memory/agent-design-team-decisions.json # Design specifications
  - .claude/memory/agent-qa-decisions.json          # Test results

# Write accessibility findings
write: .claude/memory/agent-accessibility-review-decisions.json
  workstream_id: <id>
...
**ESCALATES TO:** leadership-team (accessibility policy decisions, resource allocation for remediation)
