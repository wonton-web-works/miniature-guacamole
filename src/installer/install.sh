#!/usr/bin/env bash
# ============================================================================
# miniature-guacamole project-local installer (v1.x)
# ============================================================================
...
usage() {
    cat <<EOF
miniature-guacamole installer (v1.x)
...
log_warning "Note: Claude Code will ask you to trust this project directory"
