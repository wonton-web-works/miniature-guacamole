...
describe('Accessibility Review - WS-11', () => {
  describe('accessibility-review SKILL.md', () => {
    const skillPath = path.join(SKILLS_DIR, 'accessibility-review', 'SKILL.md');
    ...
    it('should have frontmatter with name', () => {
      ...
      expect(content).toMatch(/name:\s+accessibility-review/);
    });
