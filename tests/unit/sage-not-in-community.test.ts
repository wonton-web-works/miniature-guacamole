 ...
 * moved to the private private-enterprise-enterprise repo and are NOT present
...
describe('enterprise-separation — misuse cases', () => {
  ...
  it('enterprise installer tools do NOT exist in src/installer/', () => {
    const tools = ['mg-login', 'mg-upgrade', 'mg-dev-key', 'mg-status', 'verify-session.sh', 'ext-session-schema.md'];
